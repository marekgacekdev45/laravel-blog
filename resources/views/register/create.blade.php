<x-layout>
    <section class="px-6 py-8">
        <main class="max-w-lg mx-auto mt-10 bg-gray-100 border-gray-600 p-6 rounded-xl">
            ...
            <form method="POST" action="/register" class="mt-10">
                ...
                <div class="mb-6">
                    <button type="submit" class="bg-blue-400 text-white rounded py-2 px-5 hover:bg-blue-500">Submit</button>
                </div>
            </form>
        </main>
    </section>
